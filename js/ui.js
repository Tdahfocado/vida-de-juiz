  ...
  function mostrarTutorial(forcar) {
    ...
    const cartoes = [
      ...
      { titulo: "A comarca além do fórum",
        texto: "O <strong>🌳 Parque da Cidade</strong> é de <strong>acesso livre A QUALQUER HORA</strong> — dê uma volta na <strong>porta do fórum</strong> para uma pausa (lago, ciclovia e a <strong>bicicleta</strong>, uma das formas de <strong>aliviar o estresse</strong>). Ao <strong>fim da pauta</strong>, a saída também abre a <strong>rua</strong>: a <strong>🏖 ACM à beira-mar</strong> (auditório, esportes e a Diretoria — destrava com <strong>5 conquistas</strong>, pedalando do Parque), a <strong>Delegacia</strong>, a <strong>Escola</strong> e a <strong>ESMEC</strong>. Tudo aparece e se destrava no <strong>🏅 quadro de Conquistas</strong> do menu." }
    ];
    if (modo3d()) {
